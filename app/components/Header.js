...
export default function Header({light , onClick , setLight}){
 ...
 return (
    ...
    <motion.div
        ...
        className={` fixed w-full h-auto bg-white rounded flex flex-col justify-center items-center  ${light===false ? 'bg-gradient-to-tr from-gray-500 to-gray-900': 'bg-gradient-to-tl from-gray-200 to-gray-300 text-black'} py-12 sm:hidden`}>
            <button
